...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/app/Linebot-33a6cfa20c62.json'
app = Flask(__name__)
...
project_id = config['dialog']['project_id']
session_id = config['dialog']['session_id'] #access token
#imgur app
...
gmaps = googlemaps.Client(key=config['map_api']['googlemaps'])
